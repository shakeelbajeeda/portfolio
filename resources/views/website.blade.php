                ...
                <div class="banner_content">
                    ...
                    <h1 class="cd-headline clip">
                        ...
                        <span class="cd-words-wrapper">
                            <b class="is-visible fw_300">Abdul Waheed</b>
                            <b class="fw_300">Software Engineer</b>
                            <b class="fw_300">Web Developer</b>
                            <b class="fw_300">also Devops Engineer</b>
                        </span>
                    </h1>
                    <p>In a professional context it often happens that private clients corder a<br /> publication to
                        be made.</p>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="about_image wow fadeInLeft">
                        <img src="assets/images/waheed mic.jpg" alt="about-image" />
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="work_content_area">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="item-img">
                        <img src="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/1.jpg"
                            alt="" />
                        <div class="item-img-overlay">
                            <div class="overlay-info full-width">
                                <a href="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/1.jpg"
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 element-item design Photography">
                    <div class="item-img">
                        <img src="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/2.jpg"
                            alt="" />
                        <div class="item-img-overlay">
                            <div class="overlay-info full-width">
                                <a href="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/2.jpg"
                                    data-lightbox="images">
                                    <span class="icon"><i class="fa fa-plus"></i></span>
                                </a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 element-item Photography marketing">
                    <div class="item-img">
                        <img src="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/3.jpg"
                            alt="" />
                        <div class="item-img-overlay">
                            <div class="overlay-info full-width">
                                <a href="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/3.jpg"
                                    data-lightbox="images">
                                    <span class="icon"><i class="fa fa-plus"></i></span>
                                </a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 element-item design Photography">
                    <div class="item-img">
                        <img src="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/4.jpg"
                            alt="" />
                        <div class="item-img-overlay">
                            <div class="overlay-info full-width">
                                <a href="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/4.jpg"
                                    data-lightbox="images">
                                    <span class="icon"><i class="fa fa-plus"></i></span>
                                </a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 element-item marketing Photography">
                    <div class="item-img">
                        <img src="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/5.jpg"
                            alt="" />
                        <div class="item-img-overlay">
                            <div class="overlay-info full-width">
                                <a href="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/5.jpg"
                                    data-lightbox="images">
                                    <span class="icon"><i class="fa fa-plus"></i></span>
                                </a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 element-item design marketing">
                    <div class="item-img">
                        <img src="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/6.jpg"
                            alt="" />
                        <div class="item-img-overlay">
                            <div class="overlay-info full-width">
                                <a href="https://previews.customer.envatousercontent.com/files/361333503/preview/images/portfolio/6.jpg"
                                    data-lightbox="images">
                                    <span class="icon"><i class="fa fa-plus"></i></span>
                                </a>
                            </div>
...
<!-- START RESUM -->
<section id="resume" class="gray_bg section_padding pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="single_blog wow fadeInLeft">
                        <div class="blog-thumb">
                            <div class="blog-image">
                                <a href="#"><img
                                        src="https://previews.customer.envatousercontent.com/files/361333503/preview/images/blog/1.jpg"
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="single_blog wow fadeInUp">
                        <div class="blog-thumb">
                            <div class="blog-image">
                                <a href="#"><img
                                        src="https://previews.customer.envatousercontent.com/files/361333503/preview/images/blog/2.jpg"
                                        class="img-responsive" alt=""></a>
                            </div>
                            <div class="blog-info">
                                <small><i class="fa fa-clock-o"></i>July 31, 2020</small>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="single_blog wow fadeInRight">
                        <div class="blog-thumb">
                            <div class="blog-image">
                                <a href="#"><img
                                        src="https://previews.customer.envatousercontent.com/files/361333503/preview/images/blog/3.jpg"
                                        class="img-responsive" alt=""></a>
                            </div>
                            <div class="blog-info">
                                <small><i class="fa fa-clock-o"></i>July 31, 2020</small>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <form class="form" method="POST" action="{{ route('contact_us') }}">
                    @csrf
                    <div class="row">
                        <div class="input_padding text-center">
                            ...
                            <div class="form-group mb0 col-sm-12">
                                <div class="actions">
                                    <button type="submit" class="btn btn-default main_btn"
